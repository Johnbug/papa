...
| `image_change` | Switching images; `from` / `to` categories (`peach`, `shorts`, `custom`; `shorts` remains the historical category for the built-in model, now wearing jeans). Includes applying a custom image. |
